...
double scale = 1;
bool initial = true;
/*thrust::host_*/vector<PixelLoc> interiorR;
/*thrust::host_*/vector<PixelLoc> interiorL;
/*thrust::host_*/vector<PixelLoc> interior;
Image myimg;
Image myimgOther;

void runNCC(/*Matrix3x3 myH1, */double * current, int j, int k){
  //main variables
  double point[2];
...
int main(int argc, char **argv)
{
  ...
  // cudaMalloc(d_myH1, 1*sizeof(Matrix3x3));
